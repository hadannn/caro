...
public class CaroFrame extends JFrame implements ActionListener {
	...
	private String playerName1 = "Tên người 1", playerName2 = "Tên người 2";
	...
	private JPanel createPanelStatus(boolean player) {
		...
		if (player) {
			...
			lbNamePlayerX = new JLabel("ahihi 1");
			...
			lbNamePlayerO = new JLabel(" ahihi 2");
	...
	private JPanel createPlayerPanel(boolean player) {
		...
		int w = width / 3;
		String imgPlayerO = "playerO.jpg";
		String imgPlayerX = "playerX.jpg";
